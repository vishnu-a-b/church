...
export default function UnitAdminMembersScreen() {
    ...
    <View style={s.container}>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={s.banner}>
            <View style={{ flex: 1 }}>
              <Text style={s.bannerTitle}>Unit Members</Text>
        ...
        ListEmptyComponent={
          <View style={s.emptyState}>
            ...
            <Text style={s.emptyTitle}>No members in your unit</Text>
...
const s = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: '#eff6ff', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4, borderWidth: 1, borderColor: '#bfdbfe' },
