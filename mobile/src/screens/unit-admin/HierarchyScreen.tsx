    ...
    <FlatList
      ...
      ListEmptyComponent={
        <View style={s.emptyState}>
          ...
          <Text style={s.emptyTitle}>No groups in your unit</Text>
...
// ── Main screen ───────────────────────────────────────────────────────────────
export default function UnitAdminHierarchyScreen() {
...
const s = StyleSheet.create({
  ...
  cardIconWrap: { width: 44, height: 44, borderRadius: 13, backgroundColor: '#eff6ff', borderWidth: 1.5, borderColor: '#bfdbfe', justifyContent: 'center', alignItems: 'center' },
  cardBody: { flex: 1 },
  ...
  memberAvatar: { width: 38, height: 38, borderRadius: 11, backgroundColor: '#eff6ff', borderWidth: 1.5, borderColor: '#bfdbfe', justifyContent: 'center', alignItems: 'center' },
  ...
  roleBadge: { marginLeft: 6, backgroundColor: '#eff6ff', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 1, borderWidth: 1, borderColor: '#bfdbfe' },
