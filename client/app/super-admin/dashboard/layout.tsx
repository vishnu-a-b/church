...
function DashboardContent({ children }: { children: React.ReactNode }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: 'Rite Bookings', href: '/super-admin/dashboard/thirukkarmangal/bookings', icon: GiCandleFlame },
    { name: 'Rite Setup', href: '/super-admin/dashboard/thirukkarmangal', icon: GiCandleFlame },
