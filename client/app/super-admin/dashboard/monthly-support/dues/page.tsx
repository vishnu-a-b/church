...
export default function SuperAdminMonthlySupportDuesPage() {
  ...
  // Collect unique periods for the filter dropdown
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <button onClick={() => router.push('/super-admin/dashboard/monthly-support')} className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-2 text-sm">
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button onClick={handlePaymentSubmit} disabled={processingPayment} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50">
