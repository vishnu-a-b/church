...
export default function SuperAdminMonthlySupportPage() {
  ...
  const [selectedChurch, setSelectedChurch] = useState(searchParams.get('churchId') || '');
  ...
  const handleChurchChange = (id: string) => {
    setSelectedChurch(id);
    router.replace(id ? `/super-admin/dashboard/monthly-support?churchId=${id}` : '/super-admin/dashboard/monthly-support');
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={() => router.push(`/super-admin/dashboard/monthly-support/plan?churchId=${selectedChurch}`)}
                      ...
                      <tr key={`${plan._id}-actions`} className="bg-gray-50">
                        <td colSpan={6} className="px-6 py-4">
                          <div className="flex flex-wrap gap-3">
                            ...
                            <button
                              onClick={() => router.push(`/super-admin/dashboard/monthly-support/pay?planId=${plan._id}&churchId=${selectedChurch}`)}
                            ...
                            <button
                              onClick={() => router.push(`/super-admin/dashboard/monthly-support/plan?planId=${plan._id}&churchId=${selectedChurch}`)}
