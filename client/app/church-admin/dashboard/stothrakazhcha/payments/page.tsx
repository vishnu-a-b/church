...
export default function StothrakazhchaPaymentsPage() {
  ...
  const handleExportToExcel = () => {
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'Stothrakazhcha Payments');

      // Generate filename
      const filename = `Stothrakazhcha_Week${stothrakazhcha?.weekNumber}_${stothrakazhcha?.year}_Payments_${new Date().toISOString().split('T')[0]}.xlsx`;
