...
function DashboardContent({ children }: { children: React.ReactNode }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: 'Rite Bookings', href: '/church-admin/dashboard/thirukkarmangal/bookings', icon: FiBookOpen },
    { name: 'Rite Setup', href: '/church-admin/dashboard/thirukkarmangal/rites', icon: FiBookOpen },
