      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-2">
            <Link href="/church-admin/dashboard/members" className="block px-4 py-3 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors font-medium">
              Manage Members
            </Link>
            <Link href="/church-admin/dashboard/units" className="block px-4 py-3 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors font-medium">
              Manage Units
            </Link>
            <Link href="/church-admin/dashboard/transactions" className="block px-4 py-3 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-colors font-medium">
              View Transactions
            </Link>
            <Link href="/church-admin/dashboard/campaigns" className="block px-4 py-3 bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition-colors font-medium">
              Manage Campaigns
            </Link>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-teal-50 border-2 border-green-200 rounded-lg p-6">
          <h3 className="text-lg font-bold text-green-800 mb-2">✅ Church Admin Dashboard</h3>
          <p className="text-green-700 text-sm mb-4">
            You're logged in as <strong>Church Admin</strong>. You can manage all aspects of your church including units, members, and financial records.
          </p>
          <div className="bg-white rounded-lg p-4 text-xs text-gray-600">
            <p className="font-semibold mb-2">Available Features:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>Hierarchical management (Unit → Bavanakutayima → House → Member)</li>
