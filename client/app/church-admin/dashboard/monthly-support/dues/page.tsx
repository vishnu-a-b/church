              ...
              {loading ? (
                ...
                dues.map((due) => (
                  <tr key={due._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{memberName(due)}</td>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> This records a transaction for this member and updates their wallet balance.
                </p>
              </div>
