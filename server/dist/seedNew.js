...
const seedDatabase = async () => {
    try {
        ...
        console.log('\n🏛️  Creating Churches...');
        // Create Churches
        const church1 = await Church_1.default.create({
            churchNumber: 1,
            uniqueId: 'CH001',
        ...
        const church2 = await Church_1.default.create({
            churchNumber: 2,
            uniqueId: 'CH002',
        ...
        const unit1 = await Unit_1.default.create({
        ...
        const unit2 = await Unit_1.default.create({
            churchId: church1._id,
            unitNumber: 2,
            uniqueId: 'CH001-U002',
            name: 'South Zone',
        ...
        const unit3 = await Unit_1.default.create({
        ...
        const bk1 = await Bavanakutayima_1.default.create({
            unitId: unit1._id,
        ...
        const bk2 = await Bavanakutayima_1.default.create({
            unitId: unit1._id,
        ...
        const bk3 = await Bavanakutayima_1.default.create({
            unitId: unit2._id,
            bavanakutayimaNumber: 1,
        ...
        const bk4 = await Bavanakutayima_1.default.create({
            unitId: unit3._id,
            bavanakutayimaNumber: 1,
        ...
        const house1 = await House_1.default.create({
        ...
        const house2 = await House_1.default.create({
            bavanakutayimaId: bk1._id,
            houseNumber: 2,
        ...
        const house3 = await House_1.default.create({
        ...
        const house4 = await House_1.default.create({
        ...
        const house5 = await House_1.default.create({
        ...
        const superAdmin = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk1._id,
            houseId: house1._id,
        ...
        const churchAdmin = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk1._id,
            houseId: house1._id,
        ...
        const unitAdmin = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit2._id,
            bavanakutayimaId: bk3._id,
            houseId: house4._id,
        ...
        const member1 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk1._id,
            houseId: house2._id,
        ...
        const member2 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk1._id,
            houseId: house2._id,
        ...
        const member3 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk2._id,
            houseId: house3._id,
        ...
        const member4 = await Member_1.default.create({
            churchId: church2._id,
            unitId: unit3._id,
            bavanakutayimaId: bk4._id,
            houseId: house5._id,
        ...
        const member5 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk2._id,
            houseId: house3._id,
        ...
        const member6 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk2._id,
            houseId: house3._id,
        ...
        const member7 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit2._id,
            bavanakutayimaId: bk3._id,
            houseId: house4._id,
        ...
        const member8 = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit2._id,
            bavanakutayimaId: bk3._id,
            houseId: house4._id,
        ...
        const member9 = await Member_1.default.create({
            churchId: church2._id,
            unitId: unit3._id,
            bavanakutayimaId: bk4._id,
            houseId: house5._id,
        ...
        const member10 = await Member_1.default.create({
            churchId: church2._id,
            unitId: unit3._id,
            bavanakutayimaId: bk4._id,
            houseId: house5._id,
        ...
        // Add Kutayima Admin
        const kutayimaAdmin = await Member_1.default.create({
            churchId: church1._id,
            unitId: unit1._id,
            bavanakutayimaId: bk2._id,
            houseId: house3._id,
        ...
        // Create Transactions
        const transaction1 = await Transaction_1.default.create({
        ...
        const transaction2 = await Transaction_1.default.create({
        ...
        const transaction3 = await Transaction_1.default.create({
        ...
        const transaction4 = await Transaction_1.default.create({
        ...
        const transaction5 = await Transaction_1.default.create({
        ...
        const transaction6 = await Transaction_1.default.create({
        ...
        const transaction7 = await Transaction_1.default.create({
        ...
        const transaction8 = await Transaction_1.default.create({
        ...
        const transaction9 = await Transaction_1.default.create({
        ...
        const transaction10 = await Transaction_1.default.create({
        ...
        const activity1 = await SpiritualActivity_1.default.create({
            memberId: member1._id,
            activityType: 'mass',
        ...
        const activity2 = await SpiritualActivity_1.default.create({
        ...
        const activity3 = await SpiritualActivity_1.default.create({
            memberId: member3._id,
            activityType: 'prayer',
            prayerType: 'rosary',
            prayerCount: 7,
        ...
        const activity4 = await SpiritualActivity_1.default.create({
            memberId: member5._id,
            activityType: 'mass',
        ...
        const activity5 = await SpiritualActivity_1.default.create({
            memberId: member7._id,
            activityType: 'prayer',
        ...
        const activity6 = await SpiritualActivity_1.default.create({
            memberId: member9._id,
            activityType: 'fasting',
        ...
        const activity7 = await SpiritualActivity_1.default.create({
            memberId: kutayimaAdmin._id,
            activityType: 'mass',
        ...
        const activity8 = await SpiritualActivity_1.default.create({
            memberId: member1._id,
            activityType: 'prayer',
            prayerType: 'rosary',
            prayerCount: 30,
        ...
        const activity9 = await SpiritualActivity_1.default.create({
            memberId: member3._id,
            activityType: 'mass',
        ...
        const activity10 = await SpiritualActivity_1.default.create({
            memberId: member5._id,
            activityType: 'fasting',
        ...
        const activity11 = await SpiritualActivity_1.default.create({
            memberId: member7._id,
            activityType: 'mass',
        ...
        const activity12 = await SpiritualActivity_1.default.create({
            memberId: member2._id,
            activityType: 'prayer',
            prayerType: 'stations',
            prayerCount: 14,
...
seedDatabase();
//# sourceMappingURL=seedNew.js.map