...
const seedDatabase = async () => {
    try {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            // Update campaign
            if (!campaigns[0].contributors)
                campaigns[0].contributors = [];
        ...
        for (let i = 0; i < houses.length; i++) {
            ...
            campaignTransactions.push(transaction);
            // Update campaign
            if (!campaigns[1].contributors)
                campaigns[1].contributors = [];
        ...
        for (let i = 0; i < 8; i++) {
            ...
            campaignTransactions.push(transaction);
            // Update campaign
            if (!campaigns[2].contributors)
                campaigns[2].contributors = [];
        ...
        for (let i = 0; i < 5; i++) {
            ...
            campaignTransactions.push(transaction);
            if (!campaigns[3].contributors)
                campaigns[3].contributors = [];
        ...
        for (let i = 0; i < 25; i++) {
            ...
            if (!stothrakazhchas[0].contributors)
                stothrakazhchas[0].contributors = [];
        ...
        for (let i = 25; i < members.length; i++) {
            const member = members[i];
            const due = await StothrakazhchaDue_1.default.create({
                churchId: church._id,
        ...
        for (let i = 0; i < 20; i++) {
            ...
            stothraTransactions.push(transaction);
            if (!stothrakazhchas[1].contributors)
                stothrakazhchas[1].contributors = [];
        ...
        for (let i = 0; i < 15; i++) {
            ...
            stothraTransactions.push(transaction);
            if (!stothrakazhchas[2].contributors)
                stothrakazhchas[2].contributors = [];
...
seedDatabase();
//# sourceMappingURL=seedFull.js.map