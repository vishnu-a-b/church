...
const stothrakazhchaDueSchema = new mongoose_1.Schema({
    churchId: {
...
stothrakazhchaDueSchema.index({ stothrakazhchaId: 1, dueForId: 1 }, { unique: true });
...
exports.default = mongoose_1.default.model('StothrakazhchaDue', stothrakazhchaDueSchema);
//# sourceMappingURL=StothrakazhchaDue.js.map