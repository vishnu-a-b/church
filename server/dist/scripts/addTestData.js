...
async function addTestData() {
    ...
    try {
        ...
        try {
            ...
            const campaignTransactions = transactions.filter((t) => t.description?.includes('Campaign') || t.type === 'campaign_contribution');
            const stothrakazhchaTransactions = transactions.filter((t) => t.description?.includes('Stothrakazhcha') || t.type === 'stothrakazhcha_contribution');
...
//# sourceMappingURL=addTestData.js.map