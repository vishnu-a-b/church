 ...
 * Safe to run repeatedly — the {planId, dueForId, periodMonth} unique index means
 * an already-generated due is simply skipped (duplicate key error is caught per member).
 */
...
export { generateMonthlySupportDues };
